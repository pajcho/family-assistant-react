...
import { BanknotesIcon, CakeIcon } from "@heroicons/react/24/outline";
 ...
 *
 * Also the poklon corner: payments linked to this birthday are listed, and
 * "Dodaj plaćanje" opens the payment form pre-linked (payments are the only
 * money entry that can link a birthday - expenses have no birthday column).
 */
          ...
          {birthday ? (
            <div className="space-y-4">
              ...
              {/* Poklon tracking: payments linked to this birthday (renders
                  nothing without any) + one-tap add of a pre-linked payment. */}
              <LinkedPaymentsList payments={linkedPayments} />
              <Button type="button" variant="outline" className="w-full" onClick={handleAddPayment}>
