 ...
 * types, a "Lista" shortcut and quick expense entry. Every entry opens its
 * form in place: whatever you add (or back out of), you stay on Danas /
 * Uskoro. Tile sheet on mobile, labelled header dropdown on desktop.
 */
