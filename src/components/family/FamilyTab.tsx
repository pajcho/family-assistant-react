    ...
    <div className="space-y-6">
      ...
      {isWide ? (
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1 rounded-xl border border-border bg-card p-5 shadow-card">
            {detail ?? (
        ...
        <div className="rounded-xl border border-border bg-card p-5 shadow-card">{detail}</div>
      ) : (
        list
      )}
